import { forgotPasswordSchema, loginSchema, registerValidation, resetPasswordSchema, verifyOtpValidation, } from "./auth.schema.js";
...
const verifyRegistrationEmail = catchAsync(async (req, res) => {
...
export const forgotPassword = catchAsync(async (req, res) => {
    ...
    await redisClient.set(`forget_password:${resetToken}`, JSON.stringify({
        userId: user.id,
        token: hashedToken,
    }), {
        expiration: {
