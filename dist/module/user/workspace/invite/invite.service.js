...
import ejs from "ejs";
const getInvitationService = async (paylaod) => {
...
const sendInvitationService = async (payload) => {
    ...
    if (!senderMember) {
        throw new AppError("You do not have permission to send invitations for this workspace", 403);
    }
...
const acceptInvitationService = async (payload) => {
...
const deleteInvitationService = async (payload) => {
