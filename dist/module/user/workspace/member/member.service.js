...
const getWorkspaceMembersService = async (payload) => {
...
const deleteWorkspaceMemberService = async (payload) => {
    ...
    if (workspace.owner_id !== requested_by_user_id &&
        requesterMember.role !== "ADMIN") {
        throw new AppError("Only Workspace Owner or Admins can remove members", 403);
    }
