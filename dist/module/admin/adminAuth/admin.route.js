...
adminAuthRouter.post("/admins", verifyUser(PlatformRole.ADMIN), adminAuthController.createAdmin);
adminAuthRouter.post("/admins/verify", verifyUser(PlatformRole.ADMIN), adminAuthController.verifyAdmin);
